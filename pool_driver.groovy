...
metadata {
    definition (name: "Custom Pool Driver", namespace: "Rerouted", author: "Ryan Sullivan", importUrl: "https://raw.githubusercontent.com/rerouted/hubitat-pool/master/pool_driver.groovy") {
        capability "Actuator"
        capability "Sensor"
    ...
    preferences() {
        section("Query Inputs"){
            ...
            input "pollInterval", "enum", title: "Auto Poll Interval:", required: false, defaultValue: "1 Minute", options: ["1 Minute", "5 Minutes", "10 Minutes", "15 Minutes"]
...
def updated() {
    ...
    state.NumOfPolls = 0
    ForcePoll()
    def pollIntervalCmd = (settings?.pollInterval ?: "1 Minute").replace(" ", "")
    if(autoPoll)
...
def poll1(){
    ...
    def params1 = [
     ...
     //   uri: "https://pool.rainseed.net:3000/temperature"
    ]
